    ...
    private static void registerCommands(CommandDispatcher<ServerCommandSource> dispatcher) {
        dispatcher.register(CommandManager.literal("magiccraft")
                        ...
                        .then(CommandManager.argument("amount", IntegerArgumentType.integer(1))
                                .executes(context -> {
                                    ...
                                    if (player instanceof ProgressionData data) {
                                        data.setStatPoints(data.getStatPoints() + amount);
                                        player.sendMessage(Text.literal("Added " + amount + " stat points!"), false);
                                        return 1;
                                    }
                                    return 0;
                                })))
                        ...
                        .then(CommandManager.argument("amount", IntegerArgumentType.integer(1))
                                .executes(context -> {
                                    ...
                                    if (player instanceof ProgressionData data) {
                                        ...
                                        player.sendMessage(Text.literal("Added " + amount + " custom experience!"),
                                                false);
                                        return 1;
                                    }
                                    return 0;
                ...
                .then(CommandManager.literal("help")
                        .executes(context -> {
                            ServerPlayerEntity player = context.getSource().getPlayerOrThrow();
                            player.sendMessage(Text.literal("§6--- Magic Mod Commands ---"), false);
                            player.sendMessage(Text.literal("§e/magiccraft help §7- Show this help message"), false);
                            ...
                            player.sendMessage(Text.literal("§bHint: §7Press 'O' to open the Magic Progression menu!"),
                                    false);
                            return 1;
                        })));
    }
